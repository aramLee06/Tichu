...
/// <summary>
/// The Normal AI's module
/// </summary>
[Serializable]
public class AIModuleNormal : AIModuleBase
{
    /// <summary>
                ...
                case PlayKind.SINGLE_PLAY:
                    {
                        ...
                        {
                            Card card = computerPlayer.orderedHand[UnityEngine.Random.Range(0, computerPlayer.orderedHand.Count - 1)];
                ...
                case PlayKind.ONE_PAIR:
                    {
                        ...
                        if (computerPlayer.manager.lastPlay.Count == 2 && computerPlayer.pairCombos.Count > 0)
                            combo = computerPlayer.pairCombos[UnityEngine.Random.Range(0, computerPlayer.pairCombos.Count - 1)];
                        else if (computerPlayer.manager.lastPlay.Count == 4 && computerPlayer.doublePairCombos.Count > 0)
                            combo = computerPlayer.doublePairCombos[UnityEngine.Random.Range(0, computerPlayer.doublePairCombos.Count - 1)];
                        else
                            break;
                ...
                case PlayKind.THREE_OF_A_KIND:
                    {
                        ...
                        if (computerPlayer.threeOfAKindCombos.Count > 0)
                            combo = computerPlayer.threeOfAKindCombos[UnityEngine.Random.Range(0, computerPlayer.threeOfAKindCombos.Count - 1)];
                ...
                case PlayKind.FULL_HOUSE:
                    {
                        CardCombination combo = null;
                        if (computerPlayer.fullHouseCombos.Count > 0)
                            combo = computerPlayer.fullHouseCombos[UnityEngine.Random.Range(0, computerPlayer.fullHouseCombos.Count - 1)];
                        if (combo != null && combo.combinedValue > computerPlayer.manager.lastValue)
                            computerPlayer.playCards = combo.combination;
                    }
                    break;
                case PlayKind.STRAIGHT:
                    {
                        CardCombination combo = null;
                        if (computerPlayer.straightCombos.Count > 0)
                            combo = computerPlayer.straightCombos[UnityEngine.Random.Range(0, computerPlayer.straightCombos.Count - 1)];
                ...
                case PlayKind.BOMB:
                    {
                        CardCombination combo = null;
                        if (computerPlayer.bombCombos.Count > 0)
                            combo = computerPlayer.bombCombos[UnityEngine.Random.Range(0, computerPlayer.bombCombos.Count - 1)];
                        if (combo != null && combo.combinedValue > computerPlayer.manager.lastValue)
                            computerPlayer.playCards = combo.combination;
                        else
                            kind = computerPlayer.manager.lastPlayKind;
